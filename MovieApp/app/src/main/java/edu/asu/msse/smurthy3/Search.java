...
public class Search extends Activity {
    ...
    public void add(View view){
        i = new Info((String)n.getText(),(String)ra.getText(),(String)re.getText(),(String)g.getText(),(String)p.getText(),(String)a.getText(),"add");
        try {
    ...
    public void insert(String name,ContentValues values, int count){
        ...
        try {
            ...
            SQLiteDatabase crsDB = db.openDB();
            String query = "insert into movie (name, rated, released, genre, plot, movieid) values ('"+i.movie+ "','" + i.rated + "','" + i.released + "','" + i.genre+"','"+i.plot+"',"+count+");";
